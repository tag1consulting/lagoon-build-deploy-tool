...
Currently this is `core-v2.34.0` upstream, so should do something like: `v2.34.0-tag1-0.1` (keep our versioning after `v2.34.0-tag1-` prefix).
...
```bash
lagoon update deploytargets --id <id> --build-image 'ghcr.io/tag1consulting/build-deploy-image:v2.34.0-tag1-0.1'
```
