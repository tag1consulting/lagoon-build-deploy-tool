...
func generatePodTemplateSpec(
	...
	if cronjobCommand != "" {
		...
		// Tag1 customization: handle custom tolerations from docker-compose labels
		...
		// Tag1 customization: handle custom node selector from docker-compose labels
	...
	// Tag1 customization: override resources from per-service values (docker-compose labels)
	if serviceValues.Resources.Requests.Cpu != "" {
		if container.Container.Resources.Requests == nil {
			container.Container.Resources.Requests = corev1.ResourceList{}
		}
		container.Container.Resources.Requests[corev1.ResourceCPU] = resource.MustParse(serviceValues.Resources.Requests.Cpu)
	}
	if serviceValues.Resources.Requests.Memory != "" {
		if container.Container.Resources.Requests == nil {
			container.Container.Resources.Requests = corev1.ResourceList{}
		}
		container.Container.Resources.Requests[corev1.ResourceMemory] = resource.MustParse(serviceValues.Resources.Requests.Memory)
	}
	if serviceValues.Resources.Limits.Cpu != "" {
		if container.Container.Resources.Limits == nil {
			container.Container.Resources.Limits = corev1.ResourceList{}
		}
		container.Container.Resources.Limits[corev1.ResourceCPU] = resource.MustParse(serviceValues.Resources.Limits.Cpu)
	}
	if serviceValues.Resources.Limits.Memory != "" {
		if container.Container.Resources.Limits == nil {
			container.Container.Resources.Limits = corev1.ResourceList{}
		}
		container.Container.Resources.Limits[corev1.ResourceMemory] = resource.MustParse(serviceValues.Resources.Limits.Memory)
	}
	...
	if serviceValues.LinkedService != nil && serviceTypeValues.SecondaryContainer.Name != "" {
		...
		// Tag1 customization: override resources from linked service values (docker-compose labels)
		if serviceValues.LinkedService.Resources.Requests.Cpu != "" {
			if linkedContainer.Container.Resources.Requests == nil {
				linkedContainer.Container.Resources.Requests = corev1.ResourceList{}
			}
			linkedContainer.Container.Resources.Requests[corev1.ResourceCPU] = resource.MustParse(serviceValues.LinkedService.Resources.Requests.Cpu)
		}
		if serviceValues.LinkedService.Resources.Requests.Memory != "" {
			if linkedContainer.Container.Resources.Requests == nil {
				linkedContainer.Container.Resources.Requests = corev1.ResourceList{}
			}
			linkedContainer.Container.Resources.Requests[corev1.ResourceMemory] = resource.MustParse(serviceValues.LinkedService.Resources.Requests.Memory)
		}
		if serviceValues.LinkedService.Resources.Limits.Cpu != "" {
			if linkedContainer.Container.Resources.Limits == nil {
				linkedContainer.Container.Resources.Limits = corev1.ResourceList{}
			}
			linkedContainer.Container.Resources.Limits[corev1.ResourceCPU] = resource.MustParse(serviceValues.LinkedService.Resources.Limits.Cpu)
		}
		if serviceValues.LinkedService.Resources.Limits.Memory != "" {
			if linkedContainer.Container.Resources.Limits == nil {
				linkedContainer.Container.Resources.Limits = corev1.ResourceList{}
			}
			linkedContainer.Container.Resources.Limits[corev1.ResourceMemory] = resource.MustParse(serviceValues.LinkedService.Resources.Limits.Memory)
		}
